---
sidebar_position: 27
title: Spring Boot Integration | LangChain4j
description: Drop LangChain4j into a Spring Boot project via starters. Auto-configure ChatModel, EmbeddingModel, EmbeddingStore, AI Services and Tools from application.properties, and inject them with @Autowired.
keywords:
