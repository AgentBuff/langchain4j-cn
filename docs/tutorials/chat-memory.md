---
sidebar_position: 3
title: Java 对话记忆 Chat Memory 教程 | LangChain4j 中文文档
description: 通过 MessageWindowChatMemory、TokenWindowChatMemory 以及持久化 ChatMemoryStore（Redis、Cassandra、PostgreSQL、文件系统）在 Java 中管理多轮对话上下文。
keywords:
