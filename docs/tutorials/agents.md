---
sidebar_position: 7
title: Java Agents 智能体开发教程 | LangChain4j 中文文档
description: 使用 LangChain4j 在 Java 中构建 AI 智能体（Agent）：多步推理、工具调用、规划、监督、记忆与可观测性。兼容 OpenAI、Gemini、Claude、通义千问、DeepSeek 等大模型。
keywords:
  - LangChain4j Agents
  - Java 智能体
  - Java Agent
