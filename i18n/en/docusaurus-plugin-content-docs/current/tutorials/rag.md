---
sidebar_position: 8
title: RAG (Retrieval-Augmented Generation) in Java | LangChain4j
description: Build production-grade Retrieval-Augmented Generation pipelines in Java with LangChain4j. Load documents, split, embed, store in Milvus / Pinecone / PgVector / Elasticsearch / Qdrant / Weaviate, retrieve, re-rank and generate grounded answers with any LLM.
keywords:
  - LangChain4j RAG
  - Java RAG
  - Retrieval Augmented Generation Java
  - EmbeddingStore
  - DocumentSplitter
  - EmbeddingModel
  - Reranker
