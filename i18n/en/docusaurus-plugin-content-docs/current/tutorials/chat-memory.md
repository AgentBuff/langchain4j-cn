---
sidebar_position: 3
title: Chat Memory in Java | LangChain4j
description: Manage multi-turn conversation state in Java with MessageWindowChatMemory, TokenWindowChatMemory and persistent ChatMemoryStore implementations (Redis, Cassandra, Postgres, filesystem).
keywords:
