---
sidebar_position: 7
title: Tools (Function Calling) in Java | LangChain4j
description: Expose Java methods to any LLM with the @Tool annotation. LangChain4j handles schema generation, tool-call dispatching and argument binding for OpenAI, Gemini, Claude, Qwen, Ollama and more.
keywords:
  - LangChain4j Tools
  - Function Calling Java
  - Java @Tool annotation
  - LLM Tool Use
  - OpenAI Function Calling Java
