---
title: Model Context Protocol (MCP) in Java | LangChain4j
description: Use any MCP-compliant server from Java. LangChain4j ships a built-in MCP client supporting stdio and SSE transports, so remote tools become first-class @Tool-style callables inside AI Services.
keywords:
  - LangChain4j MCP
