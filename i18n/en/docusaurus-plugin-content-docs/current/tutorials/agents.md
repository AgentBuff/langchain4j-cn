---
sidebar_position: 7
title: Agents and Agentic AI in Java | LangChain4j
description: Build AI agents in Java with LangChain4j - multi-step reasoning, tool use, planning, supervision, memory and observability. Works with OpenAI, Gemini, Claude, Qwen, DeepSeek and any supported LLM provider.
keywords:
  - LangChain4j Agents
  - Java AI Agent
  - Agentic AI
