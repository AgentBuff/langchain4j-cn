---
sidebar_position: 8
title: Java RAG 检索增强生成教程 | LangChain4j 中文文档
description: 使用 LangChain4j 在 Java 项目中实现生产级 RAG（检索增强生成）：文档加载、切分、向量化、写入 Milvus / Pinecone / PgVector / Elasticsearch / Qdrant / Weaviate 等向量库，再配合 Reranker 完成召回与生成。
keywords:
  - LangChain4j RAG
  - Java RAG
  - 检索增强生成
