---
sidebar_position: 6
title: AI Services - High-level LLM API in Java | LangChain4j
description: Declare an interface, annotate methods with @SystemMessage / @UserMessage / @Tool, and LangChain4j builds a type-safe, tool-aware, memory-aware LLM client at runtime - no glue code required.
keywords:
  - LangChain4j AI Services
  - Java LLM declarative API
  - Java AI Services
